...
@EnableJpaRepositories(basePackages = "com.ravi.product_repository",
...
public class OracleDBConfig {
	...
	public LocalContainerEntityManagerFactoryBean createEMFB(EntityManagerFactoryBuilder builder) {
		...
		return builder.dataSource(createOracleDS())
					  .packages("com.ravi.product_entity")//entity class package name
					  .properties(map)
					  .build();	
	}
	...
	@Bean(name = "oraTxMgmr")
	@Primary
	public PlatformTransactionManager createTxMgmr(@Qualifier("oraEMF")EntityManagerFactory factory) {
